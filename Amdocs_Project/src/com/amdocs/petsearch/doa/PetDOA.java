...
import com.amdocs.petsearch.exception.PetException;
...
//                	throw new PetException("No pets found in category '" + petCategory + "'.");
    ...
    public List<PetClass> showAllPets() throws SQLException, PetException {
...
//            }
   ...
   public Map<String,Integer> countByVaccinationStatusForPetType(String petType) throws SQLException, PetException {
...
//       System.out.print(pets.toString());
    ...
    public List<PetClass> searchByPrice(double min, double max) throws SQLException, PetException {
...
//    	if(pets.isEmpty()) {
//    		throw new PetException("No Pet Available");
//    	}
//    	System.out.print(pets.toString());
    	return pets;
    }
